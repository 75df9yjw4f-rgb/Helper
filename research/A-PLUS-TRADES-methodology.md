...
- **Опционного позиционирования.** Проверено поиском по всему архиву: `gamma` 0 совпадений,
  `GEX` 0, `dealer` 0, `gamma flip` 0, `put/call wall` 0, `0DTE` 0. Единственное осмысленное
  упоминание опционов — про страх и неопределённость в опционном рынке как признак
  волатильности, то есть в логике GVZ, а не дилерского позиционирования.
  Их слой потока построен на другом: COT (45 упоминаний), open interest (16),
  GVZ (13), implied volatility (10), institutional (16), dark pools (1).
